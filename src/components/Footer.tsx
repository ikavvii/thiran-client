    ...
    <footer className="relative overflow-hidden border-t border-white/10">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <motion.button
            onClick={scrollToTop}
            className="flex items-center gap-2 glass rounded-full px-4 py-2 text-sm hover:bg-white/10 transition-all group"
            whileHover={{ y: -3 }}
            whileTap={{ scale: 0.95 }}
          >
            Back to Top
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 glass rounded-full flex items-center justify-center hover:bg-white/10 transition-all duration-300 z-40 group animate-glow-pulse"
